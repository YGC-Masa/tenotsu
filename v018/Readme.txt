...
4. 📱 レイアウト仕様
キャラクター表示：#char-left / #char-center / #char-right（z-index対応済）

モバイル対応：@media screen and (max-width: 768px) にてフォント・画像比率調整済み

下端合わせ：キャラ画像は .char-image で bottom: 0 に整合

重なり表示許可：キャラは最大3体同時表示、重なりを許容
